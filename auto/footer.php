  ...
  <div class="container">
    ...
    <?php the_custom_logo(); ?> 
      <div class="social footer__social">
        <a class="social__link" href="<?php bloginfo("template_url") ; ?>/assets/images/icon/sprite.svg#instagram">
          <img class="social__img" src="<?php bloginfo("template_url") ; ?>/assets/images/icon/instagram.svg" alt="instagram icon">
        </a>
        <a class="social__link" href="<?php bloginfo("template_url") ; ?>/assets/images/icon/sprite.svg#telegram">
          <img class="social__img" src="<?php bloginfo("template_url") ; ?>/assets/images/icon/telegram.svg" alt="telegram icon">
        </a>
        <a class="social__link" href="<?php bloginfo("template_url") ; ?>/assets/images/icon/sprite.svg#whatsapp">
          <img class="social__img" src="<?php bloginfo("template_url") ; ?>/assets/images/icon/whatsapp.svg" alt="whatsapp icon">
        </a>
        <a class="social__link" href="<?php bloginfo("template_url") ; ?>/assets/images/icon/sprite.svg#facebook">
